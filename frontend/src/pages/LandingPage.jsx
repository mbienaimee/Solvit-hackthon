  ...
  return (
    <div className={
      ...
      <div className={
        ...
        <img src="/vite.svg" alt="Solvit Logo" className="mx-auto mb-6 w-24 h-24 drop-shadow-lg animate-bounce" />
        <h1 className="text-4xl font-bold mb-4 tracking-tight animate-slide-down">
          Welcome to <span className={isDark ? 'text-indigo-300' : 'text-indigo-600'}>Solvit</span>
        </h1>
        <div className="mb-8">
          <div className={
            ...
            Solvit helps you find jobs, connect with mentors, and learn new skills—all in one place.
          </div>
        </div>
        <div className="flex flex-col md:flex-row gap-4 justify-center mt-6">
          <Link to="/signin" className={
            ...
            ' py-3 px-8 rounded-lg font-semibold shadow hover:bg-indigo-800 hover:scale-105 transition-all duration-200'}>
            Sign In
          </Link>
