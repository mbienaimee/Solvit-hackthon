  ...
  return (
    <div className={
      ...
      <div className={
        ...
        }>Sign In to <span className={isDark ? 'text-indigo-300' : 'text-indigo-600'}>Solvit</span></h2>
  <p className={isDark ? 'text-slate-300 mb-6' : 'text-slate-700 mb-6'}>Welcome back! Enter your details to continue.</p>
