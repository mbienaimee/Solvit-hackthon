...
const MobileHeader = () => {
  ...
  return (
    <div className="md:hidden bg-custom-accent border-b border-custom-dark px-4 py-3 flex items-center justify-between">
      <div className="flex items-center space-x-3">
        ...
        <div>
          <h1 className="text-lg font-semibold text-white">DIAMENT</h1>
