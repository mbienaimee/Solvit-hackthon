    ...
    <div className="space-y-4">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-3 bg-custom-card border border-custom-accent rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-custom-accent focus:border-transparent"
        />
      </div>
        ...
        {filterButtons.map((filter) => (
          <div key={filter.key} className="relative">
            <select
              ...
              className="appearance-none bg-custom-card border border-custom-accent rounded-lg px-4 py-2 text-white text-sm focus:outline-none focus:ring-2 focus:ring-custom-accent focus:border-transparent"
            >
